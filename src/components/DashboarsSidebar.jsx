            ...
            <div class="sidebar-menu-dashboard">
                <div class="menu-box">
                    <ul class="box-menu-dashboard">
                        ...
                        <li class="nav-menu-item">
                            <Link class="nav-menu-link" to="/dashboard/my-package">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="nav-menu-item">
                            <Link class="nav-menu-link" to="/dashboard/my-favourites">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="nav-menu-item">
                            <Link class="nav-menu-link" to="/dashboard/my-search">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="nav-menu-item">
                            <Link class="nav-menu-link" to="/dashboard/reviews">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="nav-menu-item">
                            <Link class="nav-menu-link" to="/dashboard/my-property">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <li class="nav-menu-item">
                            <Link class="nav-menu-link" to="/dashboard/add-property">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
...
export default DashboarsSidebar