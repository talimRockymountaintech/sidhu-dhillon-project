                    ...
                    <div className="col-lg-8 ">
                        <div className="content-inner">
                            <div className="heading-title">
                                ...
                                <p className="h6 fw-4">Thousands of luxury home enthusiasts just like you visit our website.
                                </p>
                            </div>
                                ...
                                <div className="form-title">
                                    <div className="tf-dropdown-sort " data-bs-toggle="dropdown">
                                        <div className="btn-select">
                                            <span className="text-sort-value">For sale</span><i className="icon-CaretDown"></i>
                                        </div>
                                        <div className="dropdown-menu">
                                            <div className="select-item active">
                                                <span className="text-value-item">For sale</span>
                                            </div>
                                            <div className="select-item">
                                                <span className="text-value-item">For rent</span>
                                            </div>
                                        </div>
                                    </div>
                                    <form>
...
<section className="tf-spacing-1 section-categories pb-0">
  <div className="tf-container">
      ...
      <div className="wrap-categories-sw">
          ...
          <div className="swiper tf-sw-categories style-pagination" data-preview="6" data-tablet="4"
              ...
              <div className="swiper-wrapper">
                  <div className="swiper-slide">
                      <a href="#" className="categories-item">
                          <div className="icon-box">
                              <i className="icon icon-apartment1">
                              </i>
                          </div>
                  ...
                  <div className="swiper-slide">
                      <a href="#" className="categories-item">
                          <div className="icon-box">
                              <i className="icon icon-townhouse">
                              </i>
                          </div>
                          <div className="content text-center">
                              <h5>Townhouse</h5>
                  ...
                  <div className="swiper-slide">
                      <a href="#" className="categories-item">
                          <div className="icon-box">
                              <i className="icon icon-commercial">
                              </i>
                          </div>
                          <div className="content text-center">
                              <h5>Commercial</h5>
              ...
              <div className="sw-pagination sw-pagination-category text-center d-lg-none d-block mt-20"></div>
          </div>
      </div>
  </div>
</section>
      ...
      <div className="row">
          <div className="col-12">
              <div className="heading-section text-center ">
                  <h2 className="title text-anime-wave">Today’s Luxury Listings</h2>
                  <p className="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                      data-wow-delay="0s">Thousands of luxury home enthusiasts just like you
                      visit our website.
                  </p>
              </div>
              <div className="swiper style-pagination tf-sw-mobile-1" data-screen="767" data-preview="1"
                  data-space="15">
                              ...
                              <div className="content">
                                  ...
                                  <div className="bot flex justify-between items-center">
                                      ...
                                      <div className="wrap-btn flex">
                                          <a href="#" className="compare flex gap-8 items-center text-1"><svg
                  ...
                  <div className="sw-pagination sw-pagination-mb-1 text-center d-lg-none d-block"></div>
              </div>
          </div>
      </div>
  </div>
...
<section className="section-help tf-spacing-1">
  <div className="tf-container">
      <div className="row">
          <div className="col-12">
              <div className="heading-section text-center">
                  <h2 className="title text-anime-wave">Discover how we can help</h2>
                  <p className="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                      data-wow-delay="0s">Thousands of luxury home enthusiasts just like you
                      visit our website.
                  </p>
                  ...
                  <div className="widget-content-tab">
                      <div className="widget-content-inner active">
                          <div className=" tf-grid-layout md-col-3 ">
                              <div className="icons-box default effec-icon animate__zoomIn wow animate__animated"
                                  ...
                                  <h4 className="title text-center"><a href="#">Find out how much you <br/>
                                          can afford</a></h4>
                                  <p className="text-center text-1">We’ll help you estimate your budget range.
                                      Save to your buyer profile to help
                                      <br/> in your search
                                  </p>
                                  <a href="#" className="tf-btn style-border pd-5 mx-auto">
                                      Learn More
                                  </a>
                              </div>
                              <div className="icons-box default effec-icon animate__zoomIn wow animate__animated"
                                  ...
                                  <h4 className="title text-center"><a href="#">Understand your <br/>
                                          monthly costs</a></h4>
                                  <p className="text-center text-1">Lorem ipsum dolor sit amet, consectetur
                              ...
                              <div className="icons-box default effec-icon animate__zoomIn wow animate__animated"
                                  ...
                                  <h4 className="title text-center"><a href="#">Get help with your down <br/>
                                          payment</a></h4>
                                  <p className="text-center text-1">In fermentum dignissim mauris et blandit.
                      ...
                      <div className="widget-content-inner ">
                          <div className="grid-layout-3">
                              <div className="icons-box default effec-icon">
                                  ...
                                  <h4 className="title text-center"><a href="#">Find out how much you
                                          can afford</a></h4>
                                  <p className="text-center text-1">We’ll help you estimate your budget range.
                                      Save to your buyer
                                      profile
                              ...
                              <div className="icons-box default effec-icon">
                                  ...
                                  <h4 className="title text-center"><a href="#">Understand your
                                          monthly costs</a></h4>
                                  <p className="text-center text-1">We’ll help you estimate your budget range.
                                      Save to your buyer
                                      profile
                              ...
                              <div className="icons-box default effec-icon">
                                  ...
                                  <h4 className="title text-center"><a href="#">Get help with your down
                                          payment</a></h4>
                                  <p className="text-center text-1">We’ll help you estimate your budget range.
                                      Save to your buyer
                                      profile
              ...
              <p className="text text-center text-1 " data-wow-duration="2s">Looking to spotlight a unique
                  property with expert
                  marketing?<a href="#" className="fw-7">Let’s chat</a></p>
          </div>
      </div>
  </div>
      ...
      <div className="row">
          <div className="col-lg-6">
              <div className="content">
                  <div className="heading-section ">
                      <h2 className="title text-anime-wave">Do you need a home loan? <br/>
                          Get pre-approved</h2>
                      <p className="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                  ...
                  <form className="form-pre-approved">
                      ...
                      <div className="cols">
                          <fieldset className="interest-rate">
                              <label className="text-1 fw-6 mb-12" for="interestRate">Interest Rate</label>
                      ...
                      <p className="text-1">Your estimated monthly payment: <span>8000</span>
                      </p>
                      <div className="wrap-btn">
                          <a href="#" className="tf-btn bg-color-primary pd-6 fw-7">
                              Calculate now
                          </a>
                          <a href="#" className="tf-btn style-border pd-7 fw-7 ">Start over</a>
                      </div>
                  </form>
              </div>
          </div>
          <div className="col-lg-6">
              <div className="image-wrap img-animation wow animate__animated">
                  <img className="lazyload parallax-img" data-src="images/section/section-pre-approved.jpg"
                      src="images/section/section-pre-approved.jpg" alt=""/>
              </div>
          </div>
      </div>
  </div>
      ...
      <div className="col-12">
          ...
          <div className="wrap-neighborhoods">
              <div className="box-location hover-img item-1">
                  <div className="image-wrap">
                      <a href="#">
                          <img className="lazyload" data-src="images/section/location-9.jpg"
                              src="images/section/location-9.jpg" alt=""/>
                      </a>
                  ...
                  <div className="content">
                      ...
                      <a href="#"
                          className="text-1 tf-btn style-border pd-23 text-white  tf-btn style-border pd-23">2.491
                          Properties <i className="icon-arrow-right"></i></a>
                  </div>
              </div>
              <div className="box-location hover-img item-2">
                  <div className="image-wrap">
                      <a href="#">
                          <img className="lazyload" data-src="images/section/location-10.jpg"
                              src="images/section/location-10.jpg" alt=""/>
                      </a>
                  </div>
                  <div className="content">
                      <h6 className="text-white">New York</h6>
                      <a href="#" className="text-1 tf-btn style-border pd-23 text-white">2.491 Properties <i
              ...
              <div className="box-location hover-img item-3">
                  <div className="image-wrap">
                      <a href="#">
                          <img className="lazyload" data-src="images/section/location-11.jpg"
                              src="images/section/location-11.jpg" alt=""/>
                      </a>
                  </div>
                  <div className="content">
                      <h6 className="text-white">New York</h6>
              ...
              <div className="box-location hover-img item-4">
                  <div className="image-wrap">
                      <a href="#">
                          <img className="lazyload" data-src="images/section/location-12.jpg"
                              src="images/section/location-12.jpg" alt=""/>
                      </a>
                  </div>
                  <div className="content">
                      <h6 className="text-white">New York</h6>
              ...
              <div className="box-location hover-img item-5">
                  <div className="image-wrap">
                      <a href="#">
                          <img className="lazyload" data-src="images/section/location-13.jpg"
                              src="images/section/location-13.jpg" alt=""/>
                      </a>
                  </div>
                  <div className="content">
                      <h6 className="text-white">New York</h6>
              ...
              <div className="box-location hover-img item-6">
                  <div className="image-wrap">
                      <a href="#">
                          <img className="lazyload" data-src="images/section/location-14.jpg"
                              src="images/section/location-14.jpg" alt=""/>
                      </a>
                  </div>
                  <div className="content">
                      <h6 className="text-white">New York</h6>
              ...
              <div className="box-location hover-img item-7">
                  <div className="image-wrap">
                      <a href="#">
                          <img className="lazyload" data-src="images/section/location-15.jpg"
                              src="images/section/location-15.jpg" alt=""/>
                      </a>
                  </div>
                  <div className="content">
                      <h6 className="text-white">New York</h6>
  ...
  <div className="tf-container">
      <div className="row">
          <div className="col-12">
              ...
              <div className="swiper style-pagination tf-sw-mobile" data-screen="992" data-preview="1"
                  data-space="15">
                  <div className="swiper-wrapper tf-layout-mobile-lg lg-col-2 ">
                      <div className="swiper-slide">
                          <div className="box-house hover-img style-list ">
                              <div className="image-wrap">
                                  <a href="property-detail-v1.html">
                                      <img className="lazyload" data-src="images/section/box-house-list-1.jpg"
                                          src="images/section/box-house-list-1.jpg" alt=""/>
                                  </a>
                                  <ul className="box-tag flex gap-8 ">
                                      <li className="flat-tag text-4 bg-main fw-6 text-white">For Sale</li>
                                  </ul>
                                  <div className="list-btn flex gap-8 ">
                                      <a href="#" className="btn-icon save hover-tooltip"><i
                                              className="icon-save"></i>
                              ...
                              <div className="content">
                                  ...
                                  <ul className="meta-list flex">
                                      <li className="meta-item">
                                          <div className="text-9 flex"><i
                                                  className="icon-bed"></i>Beds<span>4</span>
                                          </div>
                                          <div className="text-9 flex"><i
                                                  className="icon-sqft"></i>Sqft<span>1150</span>
                                          </div>
                                      </li>
                                      <li className="meta-item">
                                          <div className="text-9 flex"><i
                                                  className="icon-bath"></i>Baths<span>2</span>
                                          </div>
                                          <div className="text-9 flex"><i
                                                  className="icon-garage"></i>Garage<span>2</span>
                                          </div>
                                      </li>
                      ...
                      <div className="swiper-slide">
                          <div className="box-house hover-img style-list ">
                              <div className="image-wrap">
                                  <a href="property-detail-v1.html">
                                      <img className="lazyload" data-src="images/section/box-house-list-2.jpg"
                                          src="images/section/box-house-list-2.jpg" alt=""/>
                                  </a>
                                  <ul className="box-tag flex gap-8 ">
                                      <li className="flat-tag text-4 bg-main fw-6 text-white">For Sale</li>
                                  </ul>
                      ...
                      <div className="swiper-slide">
                          <div className="box-house hover-img style-list ">
                              <div className="image-wrap">
                                  <a href="property-detail-v1.html">
                                      <img className="lazyload" data-src="images/section/box-house-list-3.jpg"
                                          src="images/section/box-house-list-3.jpg" alt=""/>
                                  </a>
                                  <ul className="box-tag flex gap-8 ">
                                      <li className="flat-tag text-4 bg-main fw-6 text-white">For Sale</li>
                                  </ul>
                      ...
                      <div className="swiper-slide">
                          <div className="box-house hover-img style-list ">
                              <div className="image-wrap">
                                  <a href="property-detail-v1.html">
                                      <img className="lazyload" data-src="images/section/box-house-list-4.jpg"
                                          src="images/section/box-house-list-4.jpg" alt=""/>
                                  </a>
                                  <ul className="box-tag flex gap-8 ">
                                      <li className="flat-tag text-4 bg-main fw-6 text-white">For Sale</li>
                                  </ul>
  ...
  <div className="wg-partner  tf-spacing-1">
      <div className="tf-container">
          <div className="row">
              <div className="col-12">
                  <div className="heading-section  text-center mb-48">
                      <h2 className="title text-white text-anime-wave">Let’s Work Together</h2>
                      <p className="text-1 text-white wow animate__fadeInUp animate__animated"
                  ...
                  <div className="swiper brand-slide " data-preview="6" data-tablet="4" data-mobile-sm="3"
                      data-mobile="1.8" data-space="15" data-space-md="30" data-space-lg="30">
                      <div className="swiper-wrapper">
                          <div className="swiper-slide">
                              <div className="partner-item style-2 ">
              ...
              <div className="col-12">
                  <div className="content">
                      <div className="heading-section mb-30">
                          <h2 className="title text-anime-wave">Are You Selling Or <br/>
                      ...
                      <div className="person wow animate__fadeInRight animate__animated"
                          data-wow-duration="2s">
                          <img src="images/section/person-1.png" alt=""/>
                      </div>
                  </div>
              </div>
          </div>
...
<section className="section-opinion ">
  <div className="tf-container">
      <div className="row">
          <div className="col-12">
              <div className="heading-section text-center mb-48">
                  <h2 className="title text-anime-wave">Insight & Opinion</h2>
                  <p className="text-1 wow animate__fadeInUp animate__animated" data-wow-duration="1.5s"
                      data-wow-delay="0s">Thousands of luxury home enthusiasts just like you
                      visit our website.
                  </p>
              </div>
              <div className="swiper style-pagination tf-sw-latest" data-preview="3" data-tablet="2"
                  ...
                  <div className="swiper-wrapper ">
                          ...
                          <div className="blog-article-item style-2 hover-img ">
                              <div className=" image-wrap ">
                                  <a href="blog-details.html">
                                      <img className="lazyload" data-src="images/blog/blog-grid-1.jpg"
                                          src="images/blog/blog-grid-1.jpg" alt=""/>
                                  </a>
                              ...
                              <div className="article-content">
                                  ...
                                  <h4 className="title  ">
                                      <a href="blog-details.html" className="line-clamp-2">Building gains into
                                          housing
                                          stocks and how to
                                          trade the...</a>
                                  </h4>
                      ...
                      <div className="swiper-slide">
                          <div className="blog-article-item style-2 hover-img ">
                              <div className=" image-wrap ">
                                  <a href="blog-details.html">
                                      <img className="lazyload" data-src="images/blog/blog-grid-2.jpg"
                                          src="images/blog/blog-grid-2.jpg" alt=""/>
                                  </a>
                                  <div className="box-tag">
                                      <div className="tag-item text-4 text-white fw-6">News</div>
                                  </div>
                              </div>
                              <div className="article-content">
                                  <div className="time">
                      ...
                      <div className="swiper-slide ">
                          <div className="blog-article-item style-2 hover-img">
                              <div className=" image-wrap ">
                                  <a href="blog-details.html">
                                      <img className="lazyload" data-src="images/blog/blog-grid-3.jpg"
                                          src="images/blog/blog-grid-3.jpg" alt=""/>
                                  </a>
                                  <div className="box-tag">
                                      <div className="tag-item text-4 text-white fw-6">Real estate</div>
                                  </div>
  ...
  <div className="tf-container">
      <div className="row">
          <div className="col-12">
              ...
              <div className="tf-grid-layout md-col-3 loadmore-item-8">
                  <div className="box-testimonials">
                      <div className="wg-testimonial style-2">
                          ...
                          <p className="text-1 description">Aenean orci lorem, pharetra ac imperdiet eget,
                          ...
                          <div className="author">
                              <div className="avatar">
                                  <img src="images/avatar/testimonials-4.jpg" alt=""/>
                              </div>
                              <div className="content">
                                  <h6 className="name">
                      ...
                      <div className="wg-testimonial style-2">
                          ...
                          <p className="text-1 description">In hac habitasse platea dictumst. Sed eleifend
                          ...
                          <div className="author">
                              <div className="avatar">
                                  <img src="images/avatar/avt-png7.png" alt=""/>
                              </div>
                              <div className="content">
                                  <h6 className="name">
                      ...
                      <div className="wg-testimonial style-2">
                          ...
                          <p className="text-1 description">Lorem ipsum dolor sit amet, consectetur adipiscing
                          ...
                          <div className="author">
                              <div className="avatar">
                                  <img src="images/avatar/avt-png12.png" alt=""/>
                              </div>
                              <div className="content">
                                  <h6 className="name">
                  ...
                  <div className="box-testimonials">
                      ...
                      <div className="wg-testimonial style-2">
                          ...
                          <p className="text-1 description">Vivamus at nisl ornare, vulputate turpis finibus,
                              posuere metus. Donec in placerat felis. Praesent ante tellus, dignissim nec
                              imperdiet ac.</p>
                          <div className="author">
                              <div className="avatar">
                                  <img src="images/avatar/avt-png6.png" alt=""/>
                              </div>
                              <div className="content">
                                  <h6 className="name">
                      ...
                      <div className="wg-testimonial style-2">
                          ...
                          <p className="text-1 description">Quisque tincidunt, nunc vitae maximus lobortis,
                          ...
                          <div className="author">
                              <div className="avatar">
                                  <img src="images/avatar/avt-png5.png" alt=""/>
                              </div>
                              <div className="content">
                                  <h6 className="name">
                  ...
                  <div className="box-testimonials">
                      <div className="wg-testimonial style-2">
                          ...
                          <p className="text-1 description">"My experience with property management services
                          ...
                          <div className="author">
                              <div className="avatar">
                                  <img src="images/avatar/avt-png8.png" alt=""/>
                              </div>
                              <div className="content">
                                  <h6 className="name">
                  ...
                  <button className="tf-btn bg-color-primary fw-7 mx-auto btn-loadmore view-more-button">Show
                      more...
                  </button>
              </div>
